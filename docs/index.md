...
- [MSC 6 service architecture](codebase.md#msc6-service-architecture): converter ownership, direct consumer injection, source evidence, version-specific checkpoints, and breaking Python API migration and current import examples. Keywords: MSC6, reader, discovery, metrics, checkpoint, package structure, MAGETabEvidenceResolver, lookup ordering.

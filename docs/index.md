...
- id: native-archive-contract
  ...
  purpose: Documents archive extension, field mappings, explicit instrument_platform families, stable local platforms, unknown-family isolation and native protocol-method recovery helpers.
...
- id: native-archive-fidelity
  ...
  purpose: Identity validation, structured workflow merging and file URI export contracts; structured checksums, analysis-scoped CRAM/CRAI companions and catalogue-backed locations.

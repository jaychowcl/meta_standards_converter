...
- id: native-archive-imports
  ...
  purpose: Native SRA/ENA discovery, parsing, preservation and conversion contracts; accepted-workflow library facts, coupled layout geometry, repeated secondary accession/source rows and legacy positional import.
...
- id: native-archive-contract
  ...
  purpose: Documents residual extension and field mappings, occurrence-scoped administrative projections, opaque reference targets, verified organization identity, platform families and native protocol-method recovery.
...
- id: native-archive-fidelity
  ...
  purpose: Identity validation, structured workflow merging and file URI export contracts; structured checksums, CRAM/CRAI diagnostics, catalogue-backed locations, unbound annotations and person identity before display deduplication.

...
- id: native-archive-imports
  ...
  purpose: Native SRA/ENA discovery, parsing, preservation and conversion contracts; accepted-workflow library facts, shared-run consensus, missing authored cells, coupled layout geometry, repeated secondary accession/source rows and legacy positional import.
  keywords: sra2json, ena2json, SRASource, ENASource, SRAParser, ENAParser, extensions.insdc, native identity, custom factor names, explicit protocols, BioSample Owner, EntrezRecords, ENA linked NCBI contacts, Contacts, contact_ref, secondary_email, JSON cross-references, ELink, DOI verification, PMCID, numeric PMID normalization, versionless assembly cross-references, scoped publications, PubMed hydration, publication-only enrichment, publication status, final IDF comment order, protocol deduplication, P-MTAB, protocol block, unused protocols, native FASTQ rows, checksum verified mirrors, FASTQ_ALTERNATIVE_URI, file aliases, repeated processed relationships, SRF, SUBMITTED_FILE, ARCHIVE_FILE, index reads, archive alternatives, ArrayExpress accession comments, NONE file placeholders, spaced ENA dates, administrative sample status, complete_native_paths, channel molecule, study supplementary file, result-scoped processing, INSDC center, organization relationships, BioSample access, no-enrich cleanup, native date precision, scoped protocol enrichment, ordered processing branches, conflicting run identifiers, paired file aliases, peer-only runs, enrichment precedence, verified E-GEOD lookup, CLI reports
...
- id: native-archive-contract
  ...
  purpose: Documents residual extension and field mappings, occurrence-scoped administrative projections, verified Sample Name, local Alias namespace, full unit groups, opaque reference targets, verified organization identity, platform families and native protocol-method recovery.
...
- id: native-archive-fidelity
  ...
  purpose: Identity validation, structured workflow merging and file URI export contracts; structured checksums, CRAM/CRAI diagnostics, catalogue-backed locations, literal filename hashes, unbound unit companions, scoped plate preparation and person identity before display deduplication.
  keywords: exact coupled organism occurrence, original read inventories, strict subset, sparse file ambiguity, compatibility components, aliased workflow residuals, inverse source projection, verified companion bundle, occurrence ambiguity, compound method application, exact BioSamples attribute fallback, opaque file origins, companion_files, result_layout, MEX, Cell Ranger, MATRIX_BARCODES, MATRIX_FEATURES, assembly supporting documents, primary read sets, explicit mate index lane coverage, file repository, source_accession, SAMPLE_FILE, source-scoped results, scoped IDF people, inline sample contacts, exact person facts, ambiguous protocol definitions, registered protocol identity, protocol type aliases, PRJA, BioProject UID, BioSample UID, Accession search, PRJDA, assembly version, File URI, qualified units, contributor, organization, platform, person roles, scoped dates, associated analysis, indexed file locations, structured addresses, assembly reports, padded protocol slots, unnamed protocol definitions, sparse file paths, complete result branches, native SDRF topological ordering, protocol column anchors, filename-only result coverage, checksum aliases, repeated vocabulary versions, additive scoped contact references, native assay evidence, blank ontology identifiers, submitted filename scan aliases, residual channel siblings, bounded SequenceDataURI ranges, authored method projection coverage, BioSD_SAMPLE accession projection, database, sample_ref, indexed_statistics, harmonization decoding
...
- id: native-archive-validation
  ...
  keywords: TDD, offline, live_api, accession joins, downstream exports, saved run refresh, citation preservation, identifier-bound publication merge, transitive citation conflicts, publication occurrence counts, partial retrieval, BioSample owner roles, linked ontology completion, compatible enrichment annotations, biological node scope, compound method normalization, explicit experiment factors, legacy ontology URI

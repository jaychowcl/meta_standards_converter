...
# =============================================================================
"""Command-line interface for study-scoped NCBI SRA conversion."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Convert INSDC accessions through NCBI SRA to study-scoped MINiML JSON."
    )
...
def main(argv=None) -> int:
    ...
    converter = sra2json(resource_profile=configured_resource_profile(args, parser))
    failed = False

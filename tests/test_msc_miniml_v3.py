...
def test_v3_is_typed_source_neutral_and_preserves_semantic_order() -> None:
    result = MINiMLCodec().decode(package_v3())
...
def test_v3_rejects_opaque_mage_tab_and_unknown_sibling_fields() -> None:
    payload = package_v3()
...
def test_v3_validates_protocol_references_and_natural_identity() -> None:
    payload = package_v3()

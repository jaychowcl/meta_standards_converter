...
@pytest.mark.xfail(strict=True, reason="MSC-TEST-001: auto detection interprets explicit 5-prime kit as 10x v2 3-prime")
def test_auto_handler_must_not_contradict_explicit_five_prime_protocol(workspace, replay):
    ...
    assert row[header.index("Comment[end bias]")] != "3 prime tag"

...
def test_output_exports_combined_obs_and_optional_metadata_sidecars(tmp_path):
...
def test_output_aggregates_obs_metadata_without_combining_expression(tmp_path):
    sources = []
    samples = []
...
def test_output_manifest_writes_selected_format_and_json_summary(tmp_path):
